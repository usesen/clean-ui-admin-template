      ...
      <div class="alert alert-warning" role="alert">
        <p class="mb-0">
          ...
          <a
            ...
            class="mr-3"
          >Bootstrap Framework Documentation</a>
        </p>
      </div>
      <br>
      <div class="row">
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="text-black">Set Black color to element</span>
                    </td>
                  </tr>
                  <tr>
                    <td class="text-nowrap">
          ...
          <div class="mb-5">
            ...
            <table class="table table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-nowrap">
                    <code>.utils__link--underlined.utils__link--blue</code>
                  </td>
                  <td>
                    <a
                      href="javascript: void(0)"
                      target="_blank"
                      class="utils__link--underlined utils__link--blue"
                    >
                      Underlined
                      and Blue Link
                    </a>
          ...
          <div class="mb-5">
            ...
            <div class="utils__example">
              <div class="row">
                <div class="col-md-4">
                  <div
                    class="text-truncate height-100"
                    style="border:1px dashed #e6e8ea;"
                  >This is text truncate. This is text truncate. This is text truncate. This is text truncate</div>
                </div>
                <div class="col-md-4">
                  <div
                    class="text-break height-100"
                    style="border:1px dashed #e6e8ea;"
                  >This-is-text-break.This-is-text-break.This-is-text-break.This-is-text-break</div>
                </div>
                <div class="col-md-4">
                  <div
                    class="text-nowrap height-100"
                    style="border:1px dashed #e6e8ea;overflow: hidden;"
                  >This is text nowrap. This is text nowrap. This is text nowrap. This is text nowrap</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="mb-5">
            ...
            <div class="utils__example">
              ...
              <p class="text-justify">
                Justified text: Lorem Ipsum is simply dummy
