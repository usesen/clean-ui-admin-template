...
<section class="card">
  <div class="card-header">
    <span class="cui-utils-title">
      ...
      <a href="https://datatables.net/" target="_blank" class="btn btn-sm btn-primary ml-2"
  ...
  <div class="card-body">
    ...
    <div class="row">
      <div class="col-lg-12">
        <h5 class="text-black"><strong>Fixed Columns</strong></h5>
        <p class="text-muted">
          Element: read
          <a href="https://datatables.net/extensions/fixedcolumns/" target="_blank"
            >official documentation<small
              ><i class="icmn-link ml-1"><!-- --></i></small
            ></a
          >
    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <p class="text-muted">Modifier: <code>.table-inverse</code>, etc.</p>
        <div class="mb-5">
          <table class="table table-inverse nowrap" id="example3">
            <thead>
              <tr>
                <th>Name</th>
                <th>Position</th>
