            ...
            <div style="max-width: 700px; margin: 0px auto; font-size: 14px">
              ...
              <div style="text-align: center; font-size: 12px; color: #a09bb9; margin-top: 20px">
                <p>
                  ...
                  <a href="javascript: void(0);" style="color: #a09bb9; text-decoration: underline;"
                    >Unsubscribe</a
                  >
                  <br />
                  Powered by Clean UI HTML
                </p>
              </div>
            </div>
          </div>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        ...
                        <p>
                          Seems like you forgot your password for Clean UI HTML. If this is true,
              ...
              <div style="padding: 40px 40px 20px 40px; background: #fff;">
                <table style="border-collapse: collapse; border: 0; width: 100%;">
                  <tbody>
                    <tr>
                      <td>
                        <h2 style="margin-bottom: 20px; color: #24222f; font-weight: 600">
                          Thanks for Purchase!
                        </h2>
                        <p>
