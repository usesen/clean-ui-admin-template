    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="mb-5">
          ...
          <p class="text-muted">
            Modifier: <code>[data-style]</code>: <code>btn-primary</code>, <code>btn-info</code>,
            <code>btn-success</code>, <code>btn-warning</code>, <code>btn-danger</code>
          </p>
          <!-- Button Classes -->
...
<section class="card">
  <div class="card-header">
    <span class="cui-utils-title">
      ...
      <a href="https://select2.github.io/" target="_blank" class="btn btn-sm btn-primary ml-2"
        >Official Documentation <i class="icmn-link ml-1"><!-- --></i></a
      >
    </span>
  </div>
