...
<section class="card">
  <div class="card-header">
    <span class="cui-utils-title">
      ...
      <a
        href="http://www.runningcoder.org/jqueryvalidation/"
        target="_blank"
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="mb-5">
          ...
          <p class="text-muted">
            Element: read
            <a href="http://www.runningcoder.org/jqueryvalidation/" target="_blank"
        ...
        <div class="mb-5">
          ...
          <form id="form-validation-simple" name="form-validation-simple" method="POST">
            <div class="form-group">
              ...
              <input
                name="validation-simple[username]"
                type="text"
                class="form-control"
            ...
            <div class="form-group">
              ...
              <input
                name="validation-simple[password]"
                type="password"
                class="form-control"
                data-validation="[NOTEMPTY]"
              />
